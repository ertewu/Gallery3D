...
import com.cooliris.media.a_media.MediaClustering.Cluster;
...
public final class MediaFeed implements Runnable {
    ...
    private final HashMap<MediaSet, MediaClustering> mClusterSets = new HashMap<MediaSet, MediaClustering>(32);
    ...
    private final HashMap<String, ContentObserver> mContentObservers = new HashMap<String, ContentObserver>();
    /** 这是一个二维的数组？ */
    private final ArrayList<String[]> mRequestedRefreshUris = new ArrayList<String[]>();

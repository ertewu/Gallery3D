package com.cooliris.media.layer.grid;
...
import com.cooliris.media.GridCamera;
import com.cooliris.media.GridCameraManager;
import com.cooliris.media.GridDrawManager;
import com.cooliris.media.GridDrawables;
import com.cooliris.media.GridInputProcessor;
import com.cooliris.media.GridLayoutInterface;
import com.cooliris.media.GridQuad;
import com.cooliris.media.LayoutInterface;
...
import com.cooliris.media.layer.BackgroundLayer;
import com.cooliris.media.layer.PathBarLayer;
import com.cooliris.media.layer.RootLayer;
import com.cooliris.media.layer.TimeBar;
...
public final class GridLayer extends RootLayer implements MediaFeed.Listener, TimeBar.Listener {
    ...
    private final Vector3f mDeltaAnchorPosition = new Vector3f();
    ...
    private final ArrayList<MediaItem> mVisibleItems;
    ...
    public void centerCameraForSlot(int slotIndex, float baseConvergence) {
    ...
    public boolean constrainCameraForSlot(int slotIndex) {
    ...
    public DisplayItem getDisplayItemForSlotId(int slotId) {
    ...
    public boolean changeFocusToNextSlot(float convergence) {
        int currentSelectedSlot = mInputProcessor.getCurrentSelectedSlot();
    ...
    public boolean changeFocusToSlot(int slotId, float convergence) {
        mZoomValue = 1.0f;
        int index = slotId - mBufferedVisibleRange.begin;
        if (index >= 0 && slotId <= mBufferedVisibleRange.end) {
    ...
    public boolean changeFocusToPreviousSlot(float convergence) {
    ...
    public void addSlotToSelectedItems(int slotId, boolean removeIfAlreadyAdded, boolean updateCount) {

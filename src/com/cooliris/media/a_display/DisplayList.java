package com.cooliris.media.a_display;
...
import com.cooliris.media.collection.DirectLinkedList;

// CR: comment.
public final class DisplayList {
    private final DirectLinkedList<DisplayItem> mAnimatables = new DirectLinkedList<DisplayItem>();
    private final HashMap<MediaItem, DisplayItem> mDisplayMap = new HashMap<MediaItem, DisplayItem>(1024);
    private final ArrayList<DisplayItem> mItems = new ArrayList<DisplayItem>(1024);

...
import com.cooliris.media.texture.UriTexture;
...
public final class DisplayItem {
    ...
    private final Vector3f mStacktopPosition = new Vector3f(-1.0f, -1.0f, -1.0f);
    private final Vector3f mJitteredPosition = new Vector3f();

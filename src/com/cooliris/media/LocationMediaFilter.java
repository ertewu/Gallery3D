...
import com.cooliris.media.a_media.MediaFilter;
...
public class LocationMediaFilter extends MediaFilter {
    ...
    public LocationMediaFilter(double centerLatitude, double centerLongitude, double thresholdRadius) {
        mCenterLat = centerLatitude;
        mCenterLon = centerLongitude;
        mRadius = thresholdRadius;
    }

    public LocationMediaFilter(double latitude1, double longitude1, double latitude2, double longitude2) {
